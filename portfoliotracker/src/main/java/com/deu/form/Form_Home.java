...
import com.deu.component.WalletField;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    WalletField frameText;

    public Form_Home() {

        initComponents();
        frameText = WalletField.getInstance();

        ApiServices apiService = new ApiServices();
        card1.setData(new Model_Card(new ImageIcon("src/main/java/com.raven.icon/bitcoin.png"), "Bitcoin", "$" + apiService.getData("BTC"), "BTC", ""));
        card2.setData(new Model_Card(new ImageIcon("src/main/java/com.raven.icon/litecoin.png"), "Cardano", "$" + apiService.getData("ADA"), "ADA", ""));
        card3.setData(new Model_Card(new ImageIcon("src/main/java/com.raven.icon/eth2.png"), "Ethereum", "$" + apiService.getData("ETH"), "ETH", ""));
        card4.setData(new Model_Card(new ImageIcon("src/main/java/com.raven.icon/solona.png"), "Solana", "$" + apiService.getData("SOL"), "SOL", ""));
    ...
    private void initComponents() {
        ...
        card1 = new com.deu.component.Card();
        card2 = new com.deu.component.Card();
        card3 = new com.deu.component.Card();
        card4 = new com.deu.component.Card();
        panelBorder1 = new com.deu.portfoliotracker.PanelBorder();
        jLabel1 = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        table = new com.deu.swing.Table();
    ...
    private com.deu.component.Card card1;
    private com.deu.component.Card card2;
    private com.deu.component.Card card3;
    private com.deu.component.Card card4;
    private javax.swing.JButton jButton1;
    private javax.swing.JButton jButton2;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JLayeredPane panel;
    private com.deu.portfoliotracker.PanelBorder panelBorder1;
    private static com.deu.swing.Table table;
